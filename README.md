...
> This fork of snarkjs implements necessary changes to build aggregation circuit for circom-plonk proofs using Maze tool. Follow the tutorial to understand how to use Maze with snarkjs.
